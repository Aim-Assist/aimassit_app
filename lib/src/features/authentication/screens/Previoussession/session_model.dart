...
class SessionModel {
  ...
  SessionModel({required this.sessionNumber, required this.avgScore, required this.scores});
}

List<SessionModel> sessionData = [
  SessionModel(sessionNumber: 1, avgScore: 80, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 2, avgScore: 90, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 3, avgScore: 85, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 4, avgScore: 75, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 5, avgScore: 95, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 6, avgScore: 87, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 7, avgScore: 78, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 8, avgScore: 83, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 9, avgScore: 91, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
  SessionModel(sessionNumber: 10, avgScore: 88, scores: [85, 78, 92, 80, 90, 88, 75, 82, 87, 93]),
];
